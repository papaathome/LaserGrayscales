...
namespace As.Applications.Converters
{
    ...
    public class ConverterToIntCi : IValueConverter
    {
        public object ConvertBack(
            ...
            object parameter,
            CultureInfo culture)
            => int.TryParse(value as string, CultureInfo.InvariantCulture, out int v) ? v : DependencyProperty.UnsetValue;
        ...
        public object Convert(
            ...
            object parameter,
            CultureInfo culture)
            => ((int)value).ToString(parameter as string ?? "0", CultureInfo.InvariantCulture);
    }
}

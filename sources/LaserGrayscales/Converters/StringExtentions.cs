...
namespace As.Applications.Converters
{
    static public class StringExtentions
    {
        ...
        static public List<string> ToLst(this string value, string? field_seperator = null)
        {
            if (string.IsNullOrEmpty(value)) return [];
            return new List<string>(value.Split(field_seperator ?? FS));
        }

        static public string ToStr(this List<string> value, string? field_seperator = null)
        {

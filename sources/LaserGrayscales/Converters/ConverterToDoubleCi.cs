...
namespace As.Applications.Converters
{
    ...
    public class ConverterToDoubleCi : IValueConverter
    {
        public object ConvertBack(
            ...
            object parameter,
            CultureInfo culture)
            => double.TryParse(value as string, CultureInfo.InvariantCulture, out double v) ? v : DependencyProperty.UnsetValue;
        ...
        public object Convert(
            ...
            object parameter,
            CultureInfo culture)
            => ((double)value).ToString(parameter as string ?? "0.###", CultureInfo.InvariantCulture);
    }
}
